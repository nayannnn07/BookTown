...
<?php include 'userNavbar.php'; ?>
    ...
    <div class="banner">
        ...
        <div class="welcome">
            <p>
                Welcome TO THE BOOKTOWN,    
                <?php  
                    echo $_SESSION['user'];
                ?>
                <br/>GET LOST IN A WORLD OF FICTION AND FANTASY WITH US
            </p>
        </div>
    </div>
    ...
    <section class="choose_books">
        <div class="container-fluid">
            <div class="choose_books_content">
                ...
                <a href="product.php" class="button-74">EXPLORE NOW</a>
            </div>
        </div>
    </section>
    ...
    <h1 class="text-center pb-5" style="font-family: 'Prata', sans-serif;" >SHOP BOOKS</h1>
         <div class="box-container">
            ...
            <div class="box">
                ...
                <button class="cartbutton" ><a href="product.php" style="text-decoration:none; color:white;" >ADD TO CART</a></button>
            </div>
        ...
        <center><button class="button-45 text-center mt-4" role="button" onclick="product.php"><a href="product.php" style="text-decoration:none; color:black;">LOAD MORE..</a></button></center>
    </section>
